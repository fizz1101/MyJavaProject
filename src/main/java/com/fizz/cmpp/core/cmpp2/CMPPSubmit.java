...
public class CMPPSubmit extends CMPP {
    ...
    private void reset() {
        ...
        this.header.setPk_cmd(CMPP_SUBMIT);
    ...
    public ByteBuffer getBody() {
        ...
        int len = 138 + getMsgLength() + getDestUsrTotal() * 21;
        ...
        buffer.appendString(getFeeTerminalId(), 21);
        ...
        while (iterator.hasNext()) {
            buffer.appendString((String) iterator.next(), 21);
        }
    ...
    public void setBody(ByteBuffer b)
        ...
        setFeeTerminalId(b.removeString(21, "ASCII"));
        ...
        //setDestTerminalId(b.removeString(21, "ASCII"));
        if (getDestUsrTotal() > 1) {
            for (int i = 1; i < getDestUsrTotal(); i++) {
                addDestTerminalId(b.removeString(21, "ASCII"));
            }
        }
        //setDestTerminalId(b.removeString(getDestUsrTotal() * 21, "ASCII"));
        ...
        setLinkId(b.removeString(8, "ASCII"));
    }
    ...
    public void setMsgContent(String value) {
        ...
        try {
            b.appendBytes(value.getBytes("GB2312"));
